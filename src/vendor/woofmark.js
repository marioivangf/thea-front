...
function prompt (options, done) {
  ...
  function remove () {
    ...
    if (dom.container.parentElement) { dom.container.parentElement.removeChild(dom.container); }
...
function render (options) {
  var dom = {
    container: e('div', 'wk-prompt ' + options.id),
    dialog: e('article', 'wk-prompt-inner'),
  ...
  dom.container[ac](dom.dialog);
  doc.body[ac](dom.container);
  return dom;
}
...
module.exports = {
  ...
  prompts: {
    link: {
      title: 'Insertar Link',
      description: 'Pega o escribe la url de tu link debajo',
